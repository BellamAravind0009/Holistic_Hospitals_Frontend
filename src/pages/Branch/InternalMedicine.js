...
const InternalMedicine = () => {
  ...
  const images = {
    banner: "https://images.unsplash.com/photo-1519494080410-f9aa8f52f1e1?q=80&w=1920&auto=format&fit=crop",
    overview: "/Images/InternalMedicine/Main1.jpg",
    doctor1: "/Images/InternalMedicine/Verma.jpg",
    doctor2: "/Images/InternalMedicine/Paul.jpg",
    doctor3: "/Images/InternalMedicine/Rao.jpg",
    diagnostics: "/Images/InternalMedicine/AD.jpg",
    ward: "/Images/InternalMedicine/IW.jpg",
    chronic: "/Images/InternalMedicine/CDM.jpg",
    preventive: "/Images/InternalMedicine/PHC.webp",
    infectious: "/Images/InternalMedicine/IDC.webp",
    geriatric: "/Images/InternalMedicine/GM.jpg"
  };

  const specialtyData = {
    name: "Internal Medicine",
    icon: <Stethoscope size={28} />,
    tagline: "Comprehensive adult healthcare with a focus on prevention and chronic disease management.",
    overview: "The Internal Medicine Department offers expert care for adults with a wide range of medical conditions. Our internists are skilled in prevention, diagnosis, and treatment of complex illnesses, and provide coordinated, long-term care for chronic diseases.",
    highlights: [
      "Personalized care for adults and seniors",
    ...
    services: [
      {
        ...
        description: "Personalized plans for diabetes, hypertension, heart disease, and more.",
        image: images.chronic
      },
      {
        name: "Preventive Health Check-ups",
        description: "Routine screenings and risk assessment for adults.",
        image: images.preventive
      },
      {
        name: "Infectious Disease Care",
        description: "Diagnosis and management of complex infections.",
    ...
    equipment: [
      {
        ...
        description: "Comprehensive laboratory and imaging services.",
        image: images.diagnostics
      },
      {
        name: "Inpatient Wards",
        description: "Comfortable, modern wards for adult and senior care.",
        image: images.ward
      }
    ],
    doctors: [
      ...
      },
      {
        ...
        description: "Focus on adult immunization and wellness.",
        image: images.doctor2
      },
      {
        name: "Dr. Kiran Rao",
        title: "Infectious Disease Consultant",
        description: "Specializes in complex infections and geriatric care.",
    ...
    testimonials: [
      {
        name: "Sunil T.",
        quote: "The internal medicine doctors provided thorough care and clear explanations."
      },
      {
        name: "Fatima A.",
        quote: "I appreciate the attention to detail and the personalized approach to my health."
      }
    ]
  };
              ...
              <div className="card-body p-4">
                ...
                <div className="mt-3 bg-light p-3 rounded-3">
                  <p className="small mb-0">
                    <strong>Note:</strong> Emergency internal medicine services are available 24/7. For urgent cases, please visit our Emergency Department.
                  </p>
                </div>
              </div>
            </div>
