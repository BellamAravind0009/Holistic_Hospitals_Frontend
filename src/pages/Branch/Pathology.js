...
const Pathology = () => {
  ...
  const images = {
    banner: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?q=80&w=1920&auto=format&fit=crop",
    overview: "/Images/Pathology/Main.jpg",
    doctor1: "/Images/Pathology/Rao.jpg",
    doctor2: "/Images/Pathology/Menon1.jpg",
    doctor3: "/Images/Pathology/Sharma.png",
    histopath: "/Images/Pathology/HP.jpg",
    cytology: "/Images/Pathology/CG.png",
    hematology: "/Images/Pathology/HG.jpg",
    microbiology: "/Images/Pathology/MB.jpg",
    lab: "/Images/Pathology/AA.webp",
    digital: "/Images/Pathology/DPS.webp"
  };

  const specialtyData = {
    name: "Pathology",
    icon: <Award size={28} />,
    tagline: "Accurate diagnostics for better healthcare.",
    overview: "Our Pathology Department provides a full range of laboratory and diagnostic services, including histopathology, cytology, hematology, and microbiology. Our expert pathologists and state-of-the-art equipment ensure precise and timely results for optimal patient care.",
    highlights: [
      "Comprehensive laboratory testing",
      "Automated and digital diagnostic systems",
      "Expert team of pathologists and lab technologists",
    ...
    services: [
      {
        ...
        image: images.histopath
      },
      {
        name: "Cytology",
        description: "Cell analysis for cancer screening and diagnosis.",
        image: images.cytology
      },
      {
        name: "Hematology",
        description: "Blood tests for anemia, infections, and blood disorders.",
        image: images.hematology
      },
      {
        name: "Microbiology",
        description: "Culture and sensitivity testing for infectious diseases.",
        image: images.microbiology
      }
    ],
    equipment: [
      {
        name: "Automated Analyzers",
        description: "High-throughput machines for rapid and accurate results.",
        image: images.lab
      },
      {
        name: "Digital Pathology Systems",
        description: "Advanced imaging and reporting for precise diagnosis.",
    ...
    doctors: [
      {
        ...
        description: "Expert in histopathology and molecular diagnostics.",
        image: images.doctor1
      },
      {
        name: "Dr. Arvind Menon",
        title: "Clinical Pathologist",
        description: "Specializes in hematology and clinical biochemistry.",
        image: images.doctor2
      },
      {
        name: "Dr. Neha Sharma",
        title: "Microbiologist",
        description: "Focus on infectious diseases and antimicrobial resistance.",
    ...
    testimonials: [
      {
        name: "Ritu S.",
        quote: "The Pathology lab provided fast and accurate reports that helped my doctor start treatment quickly."
      },
      {
        name: "Ajay K.",
        quote: "Very professional staff and modern facilities. Highly recommended for lab tests."
      }
    ]
  };
      ...
      <div className="container py-5">
        <div className="row g-4">
          ...
          <div className="col-lg-4">
            ...
            <div className="card border-0 shadow-sm rounded-4 mb-4">
              <div className="card-body p-4">
                <h4 className="fw-bold mb-3">Common Conditions We Diagnose</h4>
              ...
              <div className="card-body p-4">
                ...
                <div className="mt-3 bg-light p-3 rounded-3">
                  <p className="small mb-0">
                    <strong>Note:</strong> Emergency lab services are available 24/7 for admitted patients.
                  </p>
                </div>
              </div>
            </div>
