...
const Pediatrics = () => {
  ...
  const images = {
    banner: "https://images.unsplash.com/photo-1519864600265-abb23847ef2c?q=80&w=1920&auto=format&fit=crop",
    overview: "/Images/Pediatrics/Main.jpg",
    doctor1: "/Images/Pediatrics/Joshi.jpg",
    doctor2: "/Images/Pediatrics/Gupta.png",
    doctor3: "/Images/Pediatrics/Singh.jpg",
    wellchild: "/Images/Pediatrics/WCV.jpg",
    acute: "/Images/Pediatrics/AI.webp",
    developmental: "/Images/Pediatrics/DA.webp",
    neonatal: "/Images/Pediatrics/NC.jpg",
    ward: "/Images/Pediatrics/PW.webp",
    playroom: "/Images/Pediatrics/PAA.webp"
  };
  ...
  const specialtyData = {
    ...
    overview: "Our Pediatrics Department provides comprehensive care for infants, children, and adolescents. We focus on preventive health, growth and development, and the treatment of acute and chronic illnesses in a child-friendly environment.",
    highlights: [
      "Child-centered approach and family support",
      "Experienced pediatricians and neonatologists",
      "Developmental assessments and early intervention",
      "Immunization and preventive care programs",
      "24/7 emergency pediatric services"
    ],
    services: [
      {
        name: "Well-Child Visits",
        description: "Routine check-ups, immunizations, and growth monitoring.",
        image: images.wellchild
      },
      {
        name: "Acute Illness Care",
        description: "Expert management of common childhood illnesses and infections.",
        image: images.acute
      },
      {
        name: "Developmental Assessments",
        description: "Monitoring milestones and early intervention for developmental delays.",
        image: images.developmental
      },
      {
        name: "Neonatal Care",
    ...
    equipment: [
      {
        name: "Pediatric Ward",
        description: "Safe, colorful, and comfortable wards for children.",
        image: images.ward
      },
      {
        name: "Playroom & Activity Area",
        description: "Spaces for play and learning during recovery.",
        image: images.playroom
      }
    ],
    doctors: [
      {
        ...
        description: "Focus on preventive health and nutrition.",
        image: images.doctor1
      },
      {
        name: "Dr. Amit Gupta",
        title: "Pediatric Infectious Diseases",
        description: "Expert in childhood infections and immunization.",
        image: images.doctor2
      },
      {
        name: "Dr. Lata Singh",
        title: "Neonatologist",
        description: "Specialist in newborn and premature baby care.",
    ...
    testimonials: [
      {
        name: "Priya M.",
        quote: "The pediatricians here treat my child with so much care and patience."
      },
      {
        name: "Rahul D.",
        quote: "Wonderful doctors and friendly staff. My kids love coming here!"
      }
    ]
  };
              ...
              <div className="card-body p-4">
                ...
                <div className="mt-3 bg-light p-3 rounded-3">
                  <p className="small mb-0">
                    <strong>Note:</strong> Emergency pediatric services are available 24/7. For urgent cases, please visit our Emergency Department.
                  </p>
                </div>
              </div>
            </div>
