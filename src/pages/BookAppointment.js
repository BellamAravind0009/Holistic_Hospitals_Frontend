...
const departments = [
  "Cardiology","GeneralMedicine","Orthopedics","Neurology","Pulmonology","Ophthalmology",
  "Pediatrics","InternalMedicine","Pathology","Surgery"
];

const doctors = {
  "GeneralMedicine": ["Dr. Amanda Peterson", "Dr. James Wilson", "Dr. Sofia Garcia"],
  Pediatrics: ["Dr. Sneha Joshi","Dr. Amit Gupta", "Dr. Lata Singh"],
  Cardiology: ["Dr. Robert Chen", "Dr. Emily Williams", "Dr. Michael Rodriguez"],
  Orthopedics: ["Dr. Sarah Johnson","Dr. James Wilson", "Dr. Lisa Patel"],
  Neurology: ["Dr. David Kim","Dr. Maria Garcia", "Dr. Jonathan Taylor"],
  Ophthalmology: ["Dr. Priya Sharma","Dr. Vijay Kumar", "Dr. Meena Das"],
  Pulmonology: ["Dr. Ayesha Khan","Dr. Rahul Mehra", "Dr. Sunita Patel"],
  "Internal medicine":["Dr. Rohan Verma","Dr. Anita Paul","Dr. Kiran Rao"],
  Pathology:["Dr. Kavita Rao","Dr. Arvind Menon","Dr. Neha Sharma"],
  Surgery:["Dr. Rajesh Kumar","Dr. Anita Desai","Dr. Nitin Verma"],
};
